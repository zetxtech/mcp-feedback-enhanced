...
### v2.2.1 (窗口优化与统一设置接口)
- 🖥️ **窗口大小限制解除**：解除 GUI 主窗口最小大小限制，从 1000×800 降至 400×300，让用户可以自由调整窗口大小以符合不同使用场景 (解决 [Issue #10](https://github.com/Minidoracat/mcp-feedback-enhanced/issues/10) 第一部分)。
